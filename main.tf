...
locals {
  task_definetion  = var.ecs_task_definetion_family_revision == null ? var.ecs_task_definetion_family : "${var.ecs_task_definetion_family}:${var.ecs_task_definetion_family_revision}"
  ...
  "States": {
    "Run": {
      ...
      "Parameters": {
        ...
        "TaskDefinition": "${local.task_definetion}",
